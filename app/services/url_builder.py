...
def build_screenshot_url(adunit_data):
    ...
    base_url = "https://adplatform.example.com/platform-ad-preview/pages/ptt-article/index.html"
...
def build_native_screenshot_url(adunit_data, size, template):
    ...
    if size == '640x200':
        base_url = 'https://preview.example.com/native/pnn-article/'
    ...
    url_templates = {
        ...
        '300x300': {
            'ptt-article-list': {
                'base_url': 'https://adplatform.example.com/platform-ad-preview/pages/ptt-article-list/index.html',
